						...
						if (response.status) {
							...
							if (!data.file_path == "" || !data.file_path == null) {
								...
								if ($.inArray(fileNameExt2, exts2) !== -1) {
									...
									$(".nonmedicalmessages ul").append("<li class='right' id='bottomDivMsg" + data.id + "'>" + "<p >" + "<img width='100' class="mynam" src={{URL('/')}}/public/images/msgs/doc.png>" + "<a target='_blank' download='' href={{URL('/')}}/public/Message_files/" + data.file_name + ">" + " Download" + "</a>" + "</p>" + "<h5>" + data.msg_date + "<h5>" + "</li>");
