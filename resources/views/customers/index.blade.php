          ...
          <div class="col-lg-12">
            <section class="card">
              ...
              <div class="row"  style="padding: 20px;">
                ...
                <input  class="col-md-6 date_piker mr-2 form-control from_date hasDatepicker start_date" id="from_date" name="from_date" type="date"   placeholder="From Date" onchange="changedate(this);" value=<?php echo $fdate; ?>/>
               </div>
