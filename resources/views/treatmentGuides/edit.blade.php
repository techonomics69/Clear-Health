    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">Treatement Guides</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/admin/dashboard')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Edit Treatement Guides</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content-body">
            <div class="row">
                ...
                <div class="card-body">
                    {!! Form::model($treatmentguides,array('route' => ['treatmentGuides.update', $treatmentguides->id],'method'=>'PATCH', 'enctype'=>"multipart/form-data")) !!}
                    <div class="row">
