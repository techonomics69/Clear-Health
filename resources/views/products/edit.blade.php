                     ...
                     <div class="col-md-4 col-sm-6 col-xs-12">   
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <!-- <span class="required">*</span> -->
                                    <input type="checkbox" name="section1_button_show" value="{{$product['section1_button_show']}}" <?php if($product['section1_button_show'] == 'true'); ?>>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <!-- <span class="required">*</span> -->
                                    <input type="checkbox" name="section2_button_show" value="{{$product['section2_button_show']}}" <?php if($product['section2_button_show'] == 'true'); ?>>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="section3_button_show" value="{{$product['section3_button_show']}}" <?php if($product['section3_button_show'] == 'true'); ?>>
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
