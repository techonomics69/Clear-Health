...
{ 
  ...
  $order = checkout::join('users', 'users.id', '=', 'checkout.user_id')
            ...
            ->select('users.name', 'users.mobile', 'products.name AS product_name' , 'products.price', 'checkout.total_amount','checkout.case_id','checkout.created_at')->orderBy('checkout.id', 'DESC')->get();
