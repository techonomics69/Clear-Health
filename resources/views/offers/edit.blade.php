                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('from_date',date('Y-m-d', strtotime($offer->from_date)), array('placeholder' => '','class' => 'form-control from_date', 'onblur' => 'checkdate()','id'=>'from_date')) !!}
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label>To</label><span class="required">*</span>
                                        {!! Form::text('to_date', date('Y-m-d', strtotime($offer->to_date)), array('placeholder' => '','class' => 'form-control to_date', 'onblur' => 'checkdate()','id'=>'to_date')) !!}
                                    </div>
                                </div>
