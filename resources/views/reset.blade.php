                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('reset.password') }}" id="submitForm">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                                <input id="email" input="resetValue('email')" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" input="resetValue('password')" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password">
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" input="resetValue('confirmpass')" type="password" class="form-control" name="password_confirmation" autocomplete="new-password">
