...
class CaseManagementController extends Controller
{
    ...
    public function show($id)
    {
      ...
      $answers_data = Answers::where('case_id',$user_case_management_data['id'])->where('user_id',$user_case_management_data['user_id'])->where('category_id',$user_case_management_data['category_id'])->get();
