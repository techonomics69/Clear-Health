...
class CaseManagementController extends Controller
{
    ...
    {
      $user_case_management_data = CaseManagement::join('users','case_managements.user_id', '=', 'users.id')->select('case_managements.*','users.email', 'users.first_name', 'users.last_name', 'users.gender')->OrderBy('id' ,'DESC')->get();
      $case_status = '';
    ...
    public function show($id)
    {
      ...
      ->select('checkout.order_id','checkout.cart_id',
        'checkout.total_amount','checkout.telemedicine_fee','checkout.tax',
        'checkout_address.addressline1','checkout_address.addressline2',
        'checkout_address.city','checkout_address.state',
        'checkout_address.zipcode','products.price',
