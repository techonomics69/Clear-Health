                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                 ...
                                 <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('promocode_type', ['0'=>'Please Select','1'=>'Percentage','2'=>'Amount'], $offer->promocode_type, ['class' => 'form-control'],['id' => 'offer_type'],['onchange'=>'setPromocodevalue(this)']) !!}
                                    </div>
                                </div>
