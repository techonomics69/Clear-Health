...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="card">                
                <div class="card-body">
                {!! Form::model($blog, array('route' => ['blog.update', $blog->id],'method'=>'PATCH', 'enctype'=>"multipart/form-data")) !!}
                    <div class="row">                      
                                ...
                                <!-- <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <span class="required">*</span>
                                        {!! Form::date('published_at', null, array('placeholder' => 'Published At','class' => 'form-control')) !!}
                                        <input type="date" name="published_at" value="{{$date}}" class="form-control">
                                    </div>
                                </div>  -->
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <span>&nbsp;</span>
                                        <input <?php if($blog['most_popular']==true) echo "checked"; ?> type="checkbox" name="most_popular" id="most_popular" value="1">&nbsp;<b>Most Popular&nbsp;</b>
                                    </div>
                                </div>
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                Hour
                                                <input value="<?php echo $blog['hour']; ?>" type="number" name="hour" id="minute" class="form-control" min="1">
                                            </div>
                                            <div class="col-md-4">
                                                Minute
                                                <input value="<?php echo $blog['minute']; ?>" type="number" name="minute" id="minute" class="form-control" min="1" max="59">
                                            </div>
                                        </div>
                                    </div>
                                </div>    
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <strong>Body:</strong>
                                        <span class="required">*</span>
                                        {!! Form::textarea('body', null, array('placeholder' => 'Body','class' => 'body')) !!}
                                    </div>
...
<script type="text/javascript">
    ...
    var data = {!! json_encode($selectedTag, JSON_HEX_TAG) !!};  
      
    $("#tags").val(data).trigger('change');
</script>
