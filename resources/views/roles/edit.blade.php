                ...
                <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Edit role list</li>
                            </ol>
                        </div>
                </div>
            </div>
                                ...
                                <br/>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div id="dashboard" aria-expanded="false" class="collapse"> 
                                            ...
                                            if($first == 'dashboard'): ?>
                                            <div class="col-md-12">                                        
                                                <label class="col-md-12">{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => $first)) }}
                                    ...
                                    <div class="col-md-3">
                                        <input id="parentquiz" type="checkbox"/> 
                                        <b data-toggle="collapse" data-target="#quiz" aria-expanded="false" class="col-md-12" aria-controls="collapseOne">
                                        Quiz's
                                        </b>
                                        <div id="quiz" aria-expanded="false" class="collapse"> 
                                            @foreach($permission as $key => $value)
                                            <?php
                                            $arr = explode("-", $value->name, 2);
                                            $first = $arr[0]; 
                                    ...
                                    <div class="col-md-3">
                                        <input id="parentquizCategory" type="checkbox"/> 
                                        <b data-toggle="collapse" data-target="#quizCategory" aria-expanded="false" class="col-md-12" aria-controls="collapseOne">
                                        Quiz's Category
                                        </b>
                                        <div id="quizCategory" aria-expanded="false" class="collapse"> 
                                            @foreach($permission as $key => $value)
                                            <?php
                                            $arr = explode("-", $value->name, 2);
                                            $first = $arr[0]; 
                                            if($first == 'quizCategory'): ?>
                                            <div class="col-md-12">                                        
                                                <label class="col-md-12">{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => $first)) }}
                                                {{ ucfirst($value->name) }}</label>                                        
                                            </div> 
...
//customer checkbox
    ...
    $("#parentcustomer").change(function(){
...
// Quiz Category checkbox
    if($('.quizCategory:checked').length > 0){
        $('#parentquizCategory').prop('checked', true);
    }else{
        $('#parentquizCategory').prop('checked', false);
    }

    $("#parentquizCategory").change(function(){
        $('.quizCategory').not(this).prop('checked', this.checked);
    });
...
// Quiz checkbox
    if($('.quiz:checked').length > 0){
        $('#parentquiz').prop('checked', true);
    }else{
        $('#parentquiz').prop('checked', false);
    }

    $("#parentquiz").change(function(){
        $('.quiz').not(this).prop('checked', this.checked);
    });
