          ...
          <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            <div class="main-menu-content">
              <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item sub-menu has-sub mdmanagement-sub-menu {{ Request::is('admin/mdmanagement*') ? 'active' : '' }}">
                  <a class="menu-item" href="#">
                    ...
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                          ...
                          <path d="M3505 5108 c-88 -16 -210 -83 -278 -151 -256 -256 -210 -670 95 -867
                          217 -141 502 -108 688 78 111 110 164 241 163 397 0 157 -49 271 -163 385 -41
                          42 -98 88 -127 103 -107 57 -254 79 -378 55z"/>
                          <path d="M1693 4730 c-56 -33 -80 -117 -52 -173 6 -12 70 -81 142 -154 146
                          -148 145 -136 14 -148 -229 -20 -526 -122 -742 -255 -228 -140 -443 -351 -590
                          -579 -132 -204 -244 -513 -270 -746 -6 -59 -6 -60 11 -35 62 90 150 148 240
                          157 53 6 54 6 65 47 46 175 144 375 258 527 214 284 522 489 863 573 103 26
                          259 49 267 40 3 -3 -55 -65 -128 -138 -131 -131 -134 -135 -139 -184 -3 -40 0
                          -58 17 -85 35 -57 104 -80 168 -56 44 16 531 506 555 556 38 85 36 88 -256
                          381 -143 145 -273 270 -288 278 -38 20 -97 17 -135 -6z"/>
                          <path d="M3500 3790 c-29 -29 -25 -56 21 -127 l42 -64 -17 -150 -18 -151 37
                          -99 c28 -74 42 -99 54 -97 9 2 30 40 52 99 l37 95 -18 150 -18 149 44 69 c24
                          38 44 75 44 81 0 7 -9 24 -21 39 -20 25 -24 26 -120 26 -86 0 -102 -3 -119
                          -20z"/>
                          <path d="M2996 3754 c-111 -20 -153 -32 -208 -61 -121 -63 -218 -194 -248
                          -333 -8 -39 -10 -185 -8 -495 l3 -440 27 -40 c15 -22 44 -51 65 -65 l37 -25
                          935 -3 c1050 -3 990 -7 1055 70 22 25 39 59 45 90 14 63 14 788 1 882 -22 152
                          -128 300 -261 365 -87 42 -390 94 -413 71 -8 -8 -91 -226 -185 -485 -96 -262
                          -179 -476 -188 -482 -24 -18 -57 -16 -75 5 -9 9 -91 224 -183 477 -92 253
                          -174 468 -183 478 -19 22 -44 21 -216 -9z"/>
                          <path d="M870 2807 c-41 -20 -60 -71 -60 -164 0 -93 -12 -128 -51 -149 -44
                          -22 -68 -17 -154 32 -86 49 -128 57 -167 32 -36 -24 -259 -413 -265 -463 -6
                          -52 18 -83 101 -130 82 -46 108 -74 108 -119 0 -53 -20 -77 -111 -129 -138
                          -80 -137 -88 22 -365 155 -272 168 -280 307 -197 93 56 137 59 181 16 28 -28
                          29 -33 29 -119 0 -104 11 -144 48 -169 24 -16 52 -18 284 -18 l257 0 29 28
                          c29 28 30 32 34 139 3 110 4 110 36 139 45 41 79 38 178 -16 97 -53 132 -56
                          173 -17 40 38 252 409 258 452 6 46 -19 78 -100 126 -82 49 -105 70 -112 106
                          -12 53 11 84 102 139 97 59 118 84 110 134 -7 44 -243 452 -269 466 -40 21
                          -86 12 -159 -31 -86 -51 -123 -58 -166 -31 -40 25 -53 68 -53 176 0 85 -11
                          111 -57 134 -32 16 -500 15 -533 -2z m376 -688 c69 -26 137 -90 167 -157 46
                          -103 20 -241 -61 -325 -193 -200 -532 -49 -510 227 17 201 214 326 404 255z"/>
                          <path d="M4932 2226 c-29 -80 -121 -151 -222 -172 l-55 -11 -26 -104 c-35
                          -135 -67 -219 -134 -346 -184 -353 -504 -626 -881 -751 -103 -35 -284 -72
                          -347 -72 l-41 0 137 138 c142 143 143 146 137 222 -6 82 -120 137 -198 96 -32
                          -18 -525 -512 -541 -543 -21 -42 -13 -107 18 -149 46 -62 493 -500 528 -518
                          106 -53 223 45 191 161 -7 28 -44 72 -144 174 l-135 136 88 7 c102 9 235 35
                          348 69 622 190 1100 700 1248 1332 30 130 50 274 45 329 l-3 40 -13 -38z"/>
                          </g>
                    </svg>
                ...
                @canany(['cms-list', 'cms-create', 'cms-edit', 'cms-delete'])
                <li class="nav-item sub-menu has-sub guides-sub-menu {{ Request::is('admin/treatmentGuides*') ? 'active' : '' }}">
                  <a class="menu-item" href="#">
                     <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 512 512" height="20" viewBox="0 0 512 512" width="20"><g><circle cx="256" cy="119.631" r="87"/><circle cx="432" cy="151.63" r="55"/><circle cx="80" cy="151.63" r="55"/><path d="m134.19 256.021c-21.65-17.738-41.257-15.39-66.29-15.39-37.44 0-67.9 30.28-67.9 67.49v109.21c0 16.16 13.19 29.3 29.41 29.3 70.026 0 61.59 1.267 61.59-3.02 0-77.386-9.166-134.137 43.19-187.59z"/><path d="m279.81 241.03c-43.724-3.647-81.729.042-114.51 27.1-54.857 43.94-44.3 103.103-44.3 175.48 0 19.149 15.58 35.02 35.02 35.02 211.082 0 219.483 6.809 232-20.91 4.105-9.374 2.98-6.395 2.98-96.07 0-71.226-61.673-120.62-111.19-120.62z"/><path d="m444.1 240.63c-25.17 0-44.669-2.324-66.29 15.39 51.965 53.056 43.19 105.935 43.19 187.59 0 4.314-7.003 3.02 60.54 3.02 16.8 0 30.46-13.61 30.46-30.34v-108.17c0-37.21-30.46-67.49-67.9-67.49z"/></g></svg>
                ...
                <li class="nav-item sub-menu has-sub ordermanagement-sub-menu {{ Request::is('admin/ordermanagement*') ? 'active' : '' }}">
                  ...
                  <ul class="menu-content">
                    ...
                    <li class="nav-item sub-menu has-sub ipledgeimports-sub-menu {{-- {{ Request::is('admin/ipledgeimports') ? 'active' : '' }} --}}">
                      <a class="menu-item" href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Icons" x="0px" y="0px" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32;" width="20px" height="20px" xml:space="preserve">
                      <style type="text/css">
                  ...
                  <!-- -->
                    ...
                    <li class="nav-item sub-menu has-sub offer-promotion-sub-menu {{-- {{ Request::is('admin/ipledgeimports') ? 'active' : '' }} --}}">
                      <a class="menu-item" href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 486.982 486.982" width="20px" height="20px" style="enable-background:new 0 0 486.982 486.982;" xml:space="preserve" height="20" width="20">
                            <g>
