    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="card">                
                    <div class="card-body">
                    {!! Form::model($fees, array('route' => ['fees.update', $fees->id],'method'=>'PATCH')) !!}
                        <div class="row">                      
