	...
	<div class="col-lg-12">
		<section class="card">
			<ul class="nav nav-tabs" id="casemanagement-tab-menu">
				...
				<li><a class="btn" data-toggle="tab" href="#activity">Activity </a></li>
			</ul>
						...
						<div class="accordion" id="accordionExample">
							...
							<div class="card subcard">
								<div class="card-header" id="headingTwo{{$findex}}">
									<table width="100%">
										<tr style="cursor: pointer;"  style="background-color: #359b9e;">
											<td width="20%" onclick="questionsCollapse('collapseF{{$findex}}')" >{{$findex}}</td>
											...
											<div class="Outer_box_design">
												...
												<div class=" outre_boxes mt24">
													<table class="table table-responsive-md table-striped no-footer">
														...
														<tbody class="list_view_outer">
															<tr>
																<td scope="row">{{$user_case_management_data['bloodwork_date']}}</td>
			...
			<div class="content" style="max-height: 267px;">
				...
				<span class="case_status">
					<p class="status_heading m-0">Reason</p>
				     <p>
				     @php 
				 if($case_value['reason'] != null ||$case_value['reason'] != '' ){
				 	echo $case_value['reason'];
				 }else{echo '-';}
				@endphp </p>
				</span>			
			</div>
