...
class MessageController extends Controller
{
    ...
    public function getSupportMessage(Request $request)
    {
        ...
        $message = DB::table('support_messages')
            ...
            ->select('users.first_name', 'users.last_name', 'support_messages.user_id', 'support_messages.created_at', 'support_messages.text', 'support_messages.from', 'support_messages_files.file_path', 'support_messages_files.mime_type')
            ->get();
