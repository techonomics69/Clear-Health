@extends('layouts.app')
@section('title', "clearHealth | QuizCategory")
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
                    <div class="content-header-left col-md-6 col-12 mb-2">
                        <h3 class="content-header-title mb-0">Quiz's</h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="card">                
                    <div class="card-body">
                    {!! Form::model($quizCategory, array('route' => ['quizCategory.update', $quizCategory->id],'method'=>'PATCH')) !!}
                        <div class="row">                      
