...
public function addUserPic(Request $request)
{
  ...
  if(isset($userpic)){
    $userpicUpdate = UserPics::where('id',$userpic->id)->update([ 'left_pic'=>$user_left_pic,'straight_pic'=>$user_straight_pic,'right_pic'=>$user_right_pic,'other_pic' => $user_other_pic]
