...
class CheckoutController extends BaseController
{
  ...
  public function orderDetail(Request $request)
  {
    ...
    try{
       ...
       ->join('carts','carts.id', '=', 'checkout.cart_id')
       ->join('products', 'products.id', '=', 'carts.product_id')
       ->select('users.name', 'users.mobile', 'products.name AS product_name' , 'carts.product_price', 'checkout.total_amount','checkout.case_id','checkout.created_at')->whereIn('user_id', $request['user_id'])->OrderBy('checkout.id', 'desc')->get();
       if(!empty($order)){
